...
- **Next Task:** Phase 7 should implement the browser-wallet adapter and prepared-transaction pre-sign comparison for Sepolia, with an injected EIP-1193 provider and no public Brickken-effect routes or live writes until its safety gates pass.
